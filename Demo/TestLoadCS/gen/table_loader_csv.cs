...
namespace Test{
    ...
    public static class TableLoaderCsvUtil
	{
        ...
        public static void ReadTuple(ITableTupleReader tupleReader, ref UnityEngine.Vector3 v, out (float,float,float) v2)
        {
            v2=default;
            if(tupleReader==null)
            {
    ...
    {        
        ...
        {   
            ...
            for (; ; )
            {
				...
				TableLoaderCsvUtil.ReadTuple(rowReader.BeginTuple(), ref row.PairField, out (int,bool) __PairField);
    ...
    {        
        ...
        {   
            ...
            for (; ; )
            {
				...
				TableLoaderCsvUtil.Read(rowReader, ref row.Name);
				TableLoaderCsvUtil.ReadTuple(rowReader.BeginTuple(), ref row.Pos, out (float,float,float) __Pos);
    ...
    {        
        ...
        {   
			...
			head_rst &= ((header[0] == "Id") && (header[0+2] == "string"));
			head_rst &= ((header[1] == "Val") && (header[1+2] == "locid"));
