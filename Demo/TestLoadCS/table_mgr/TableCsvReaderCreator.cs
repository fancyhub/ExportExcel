...
namespace Test
{
    public interface ITableCsvReaderCreator
    {
        public bool CreateTableReader(string sheet_name, string lang_name, out ITableReader reader);
        public void CloseReader();
    }

    public class TableReaderCsvTextCreator : ITableCsvReaderCreator
    {
    ...
    public class TableReaderCsvBinCreator : ITableCsvReaderCreator
    {
