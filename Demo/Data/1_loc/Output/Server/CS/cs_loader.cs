...
namespace Test{
    ...
    public partial class TableMgr
    {
        ...
        public TableMgr()
        {
            _all = new Dictionary<Type, Table>(20+2);
            _loader_dict = new Dictionary<Type, TableLoader>(20+2);
        ...
        private static Table _LoadItemData(string lang)
        {
			...
			head_rst &= ((header[0] == "Id") && (header[0+7] == "int32"));
			head_rst &= ((header[1] == "Type") && (header[1+7] == "int32"));
			head_rst &= ((header[2] == "SubType") && (header[2+7] == "int32"));
			head_rst &= ((header[3] == "Quality") && (header[3+7] == "int32"));
			head_rst &= ((header[4] == "PairField") && (header[4+7] == "int32_bool"));
			head_rst &= ((header[5] == "PairFieldList") && (header[5+7] == "list_int32_int64"));
			head_rst &= ((header[6] == "ListField") && (header[6+7] == "list_int32"));
